...
## CLP Libraries and Frameworks
- **Decider**: The primary library used in this thesis
- **Google OR-Tools**: Multi-language constraint optimization
- **Choco Solver**: Java-based constraint programming
- **MiniZinc**: Constraint modeling language
- **SWI-Prolog**: Classic Prolog with CLP(FD)
